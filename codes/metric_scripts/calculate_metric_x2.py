...
def main():
    # Configurations
    folder_GT = r'D:\Wz_Project_Learning\Super_Resolution_Reconstruction\dataset\H_data\UCMerced-dataset\val\HR_x2'
    folder_Gen = r'D:\Wz_Project_Learning\Super_Resolution_Reconstruction\HAUNet_RSISR\experiment\FSMambax2_UCMerced\results'
